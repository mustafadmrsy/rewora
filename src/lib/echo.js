...
const WS_PORT = import.meta.env.VITE_REVERB_PORT || 443
...
function buildEcho() {
  ...
  return new Echo({
    ...
    wsPort: WS_PORT,
    wssPort: WS_PORT,
    forceTLS: true, // Use WSS (WebSocket Secure) when connecting through nginx HTTPS
    enabledTransports: ['wss'], // Only WSS, WS is disabled
